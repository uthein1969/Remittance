...
export const OutwardReportView: React.FC = () => {
  ...
  }, [outwardTxs, selectedCurrency, selectedStatus, selectedCountry, selectedBranch, startDate, endDate, searchQuery, db.branches]);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-3">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-white font-mono focus:outline-none focus:border-sky-500 cursor-pointer"
              title="From Date"
            />
          </div>
          ...
          {/* Country Filter (User Request #4: Clean English) */}
          <div>
            <select
              ...
              className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-white focus:outline-none focus:border-sky-500 cursor-pointer"
            >
          ...
          {/* Branch Filter (User Request #4: Clean English) */}
          <div>
            <select
          ...
          {/* Currency Filter (User Request #4: Clean English) */}
          <div>
            <select
          ...
          {/* Status Filter (User Request #4: Clean English) */}
          <div>
            <select
